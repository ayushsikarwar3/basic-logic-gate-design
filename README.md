...
Inputs are provided through switches. The selected logic gate processes the inputs according to its Boolean function and generates an output. The output is indicated using an LED.

# Results

All implemented logic gates were tested successfully, and the observed outputs matched the theoretical truth tables.
...
- Implement adders and multiplexers.
- Develop FPGA-based versions using Verilog.
